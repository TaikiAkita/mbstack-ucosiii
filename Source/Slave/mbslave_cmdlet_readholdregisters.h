...
*
* File      : MBSLAVE_CMDLET_READHOLDREGISTERS.H
* Version   : V1.0.320
* By        : Ji WenCong
*********************************************************************************************************
*/
...
#ifndef MBSLAVE_CMDLET_READHOLDREGISTERS_H__
#define MBSLAVE_CMDLET_READHOLDREGISTERS_H__
...
typedef struct {
    ...
    void                               *cbArg;
} MBSLAVE_READHOLDINGREGISTERS_CTX;
