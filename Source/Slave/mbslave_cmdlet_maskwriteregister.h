...
*
* File      : MBSLAVE_CMDLET_MASKWRITEREGISTER.H
* Version   : V1.0.320
* By        : Ji WenCong
*********************************************************************************************************
*/
...
#ifndef MBSLAVE_CMDLET_MASKWRITEREGISTER_H__
#define MBSLAVE_CMDLET_MASKWRITEREGISTER_H__
...
typedef struct {
    ...
    void                                *cbArg;
} MBSLAVE_MASKWRITEHOLDINGREGISTER_CTX;
