...
*
* File      : MBSLAVE_CMDLET_WRITEMULTIPLEREGISTERS.H
* Version   : V1.0.320
* By        : Ji WenCong
*********************************************************************************************************
*/
...
#ifndef MBSLAVE_CMDLET_WRITEMULTIPLEREGISTERS_H__
#define MBSLAVE_CMDLET_WRITEMULTIPLEREGISTERS_H__
...
typedef struct {
    MBSLAVE_WRITEHOLDINGREGISTER_CB     cbWriteHoldingReg;
    MBSLAVE_VALIDATEHOLDINGREGISTER_CB  cbValidateHoldingReg;
    void                               *cbArg;
} MBSLAVE_WRITEMULTIPLEREGISTERS_CTX;
