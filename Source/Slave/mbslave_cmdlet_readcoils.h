...
*
* File      : MBSLAVE_CMDLET_READCOILS.H
* Version   : V1.0.320
* By        : Ji WenCong
*********************************************************************************************************
*/
...
#ifndef MBSLAVE_CMDLET_READCOILS_H__
#define MBSLAVE_CMDLET_READCOILS_H__
...
typedef struct {
    MBSLAVE_READCOIL_CB      cbReadCoil;
    MBSLAVE_VALIDATECOIL_CB  cbValidateCoil;
    void                    *cbArg;
} MBSLAVE_READCOILS_CTX;
