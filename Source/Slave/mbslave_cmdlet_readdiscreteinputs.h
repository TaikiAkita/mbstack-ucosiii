...
*
* File      : MBSLAVE_CMDLET_READDISCRETEINPUTS.H
* Version   : V1.0.320
* By        : Ji WenCong
*********************************************************************************************************
*/
...
#ifndef MBSLAVE_CMDLET_READDISCRETEINPUTS_H__
#define MBSLAVE_CMDLET_READDISCRETEINPUTS_H__
...
typedef struct {
    MBSLAVE_READDISCRETEINPUT_CB      cbReadDiscreteInput;
    MBSLAVE_VALIDATEDISCRETEINPUT_CB  cbValidateDiscreteInput;
    void                             *cbArg;
} MBSLAVE_READDISCRETEINPUTS_CTX;
