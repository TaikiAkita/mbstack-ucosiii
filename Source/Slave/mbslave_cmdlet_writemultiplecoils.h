...
*
* File      : MBSLAVE_CMDLET_WRITEMULTIPLECOILS.H
* Version   : V1.0.320
* By        : Ji WenCong
*********************************************************************************************************
*/
...
#ifndef MBSLAVE_CMDLET_WRITEMULTIPLECOILS_H__
#define MBSLAVE_CMDLET_WRITEMULTIPLECOILS_H__
...
typedef struct {
    MBSLAVE_WRITECOIL_CB      cbWriteCoil;
    MBSLAVE_VALIDATECOIL_CB   cbValidateCoil;
    void                     *cbArg;
} MBSLAVE_WRITEMULTIPLECOILS_CTX;
