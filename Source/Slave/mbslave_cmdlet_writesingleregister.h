...
*
* File      : MBSLAVE_CMDLET_WRITESINGLEREGISTER.H
* Version   : V1.0.320
* By        : Ji WenCong
*********************************************************************************************************
*/
...
#ifndef MBSLAVE_CMDLET_WRITESINGLEREGISTER_H__
#define MBSLAVE_CMDLET_WRITESINGLEREGISTER_H__
...
typedef struct {
    ...
    void                                *cbArg;
} MBSLAVE_WRITESINGLEHOLDINGREGISTER_CTX;
